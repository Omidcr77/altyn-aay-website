...
const SiteBackground = () => {
  return (
    ...
    >
      {/* Base gradient wash */}
      <div className="absolute inset-0 bg-[radial-gradient(1200px_600px_at_50%_-10%,rgba(243,112,33,0.18),transparent_60%),radial-gradient(900px_500px_at_80%_20%,rgba(31,79,161,0.22),transparent_55%),linear-gradient(180deg,rgba(8,12,20,1)_0%,rgba(12,18,28,1)_40%,rgba(10,16,26,1)_100%)]" />
